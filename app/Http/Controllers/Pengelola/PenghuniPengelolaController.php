...
class PenghuniPengelolaController extends Controller
{
    ...
    public function viewPenghuni(Request $request)
    {
        ...
        $kamarKosong = Kamar::whereIn('kode_kost', $kostIds)
            ->where('status', 'kosong')
            ->get();

        return view(
            'pages.pengelola.penghuni-pengelola',
            compact(
                'daftarPenghuni',
                'permintaanMasuk',
                'permintaanKeluar',
    ...
    public function approvePenghuni(Request $request, $id)
    {
        ...
        DB::transaction(function () use ($penghuni, $request) {
            ...
            $penghuni->load('kamar');
            $penghuni->user->notify(new RequestDisetujuiNotification($penghuni));
    ...
    public function approveKeluar(Request $request, $id)
    {
        ...
        return redirect()->back()->with('success', 'Permintaan keluar berhasil disetujui.');
    }
}